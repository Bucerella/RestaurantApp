...
class DetailsFoodViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        detailsFoodView?.collectionView?.register(DetailsColletcionCiewCell.self, forCellWithReuseIdentifier: "ImageCell")
...
extension DetailsFoodViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
     let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ImageCell", for: indexPath) as! DetailsColletcionCiewCell
